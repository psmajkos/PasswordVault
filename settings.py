...
def delete_db():
  res = messagebox.askyesno("askquestion", "Are you sure?")
  if res == True:
      messagebox.showinfo('Response', 'Database deleted')
      my_conn = create_engine("mysql+pymysql://root:Pcf85830@localhost/basement")
      my_conn.execute("DROP DATABASE IF EXISTS basement")
  elif res == False:
      pass
  else:
